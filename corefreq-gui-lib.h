...
extern void StopWidget(xARG*) ;
extern GUI_REASON StartWidget( xARG*, const int, const int,
				const unsigned long int,
				const unsigned long int, const char* ) ;
extern void FreeWidget(XWINDOW*) ;
extern XWINDOW *AllocWidget(xARG*) ;
